  ...
  return (
    <div className="grid grid-cols-2 gap-4 text-gray-600 ">
      <Card className="text-gray-600">
        ...
        <Divider />
        <CardBody className="flex min-h-[60px] bg-yellow-500 justify-center items-center p-5">
          <p className="font-bold text-[20px]">Rp. 5.000.000</p>
        </CardBody>
      </Card>
      <Card className="text-gray-600">
        <CardHeader>
        ...
        <Divider />
        <CardBody className="flex min-h-[60px] bg-violet-400 justify-center items-center p-5">
          <p className="font-bold text-[20px]">Rp. 4.000.000</p>
        </CardBody>
      </Card>
      <Card className="text-gray-600">
        <CardHeader>
        ...
        <Divider />
        <CardBody className="flex h-[60px] bg-green-500 items-center justify-center p-5">
